...
def test_year_2023_day_20_part_1_1(example_inputs: ExampleInputsStore):
...
def test_year_2023_day_20_part_1_1bis(example_inputs: ExampleInputsStore):
    test_input = example_inputs.retrieve(__file__, "EXAMPLE_INPUT_1")
    start_module_dict = parse_text_to_module_dict(test_input)
    module_dict = parse_text_to_module_dict(test_input)
...
def test_year_2023_day_20_part_1_2(example_inputs: ExampleInputsStore):
...
def test_year_2023_day_20_part_1_2bis(example_inputs: ExampleInputsStore):
    test_input = example_inputs.retrieve(__file__, "EXAMPLE_INPUT_2")
    start_module_dict = parse_text_to_module_dict(test_input)
    module_dict = parse_text_to_module_dict(test_input)
    histories = compute_successive_histories_until_circle_back(
