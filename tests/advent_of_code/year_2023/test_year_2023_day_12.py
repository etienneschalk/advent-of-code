...
def test_year_2023_day_12_part_1_second_try(example_inputs: ExampleInputsStore):
...
def test_year_2023_day_12_part_2_second_try(example_inputs: ExampleInputsStore):
    test_input = example_inputs.retrieve(__file__)
    # Verify whole part 2
    parsed_input = parse_text_input_v2(test_input)
