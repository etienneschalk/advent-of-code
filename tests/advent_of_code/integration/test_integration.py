...
def test_integration_202312():
    assert AdventOfCodeProblem202312().solve_all() == {1: 7670, 2: 157383940585037}
...
def test_integration_202314():
    assert AdventOfCodeProblem202314().solve_all() == {1: 110677, 2: 90551}
...
def test_integration_202316():
    assert AdventOfCodeProblem202316().solve_all() == {1: 7236, 2: 7521}


@pytest.mark.slow
@pytest.mark.integration
def test_integration_202317():
    assert AdventOfCodeProblem202317().solve_all() == {1: 1001, 2: 1197}
...
def test_integration_202319():
    assert AdventOfCodeProblem202319().solve_all() == {1: 348378, 2: 121158073425385}
...
def test_integration_202324():
    assert AdventOfCodeProblem202324().solve_all() == {1: 19523, 2: 566373506408017}


@pytest.mark.integration
def test_integration_202325():
    assert AdventOfCodeProblem202325().solve_all() == {
        1: 601310,
