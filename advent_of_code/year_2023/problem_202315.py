...
class AdventOfCodeProblem202315(AdventOfCodeProblem[PuzzleInput]):
    ...
    def solve_part_1(self, puzzle_input: PuzzleInput):
        return sum(hash_problem_202315(i) for i in puzzle_input)
...
def hash_problem_202315_imperative(string: str):
    value = 0
    for c in string:
...
def hash_problem_202315(string: str):
...
if __name__ == "__main__":
    print(AdventOfCodeProblem202315().solve())
